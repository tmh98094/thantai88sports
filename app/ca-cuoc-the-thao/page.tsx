    ...
    <>
      ...
      <section className="section betting-section"><div className="container betting-grid">
        <div className="betting-main">
          <section><span className="eyebrow">Thông tin quan trọng</span><h2>Bạn sẽ chuyển đến website của bên thứ ba</h2><p>Nút bên dưới dẫn đến Thantai688, một nền tảng cá cược thể thao do bên thứ ba vận hành. Thantai88sport không xử lý tài khoản, tiền gửi, tiền rút, tỷ lệ cược hoặc kết quả giao dịch của bạn.</p><p>Đây là liên kết tiếp thị liên kết. Nếu người dùng thực hiện hành động đủ điều kiện, Thantai88sport có thể nhận hoa hồng. Việc này không tạo ra cam kết về kết quả hoặc lợi nhuận.</p><p>Khi cần xác minh kênh chính thức, đăng ký, đăng nhập hoặc hỗ trợ tài khoản, hãy dùng trang chính tại <a className="text-link" href="https://thantai88.online/" rel="noopener noreferrer">thantai88.online</a> trước khi tiếp tục.</p></section>
